...
export default function ClassPage() {
  ...
  if (authLoading || loading || !user) return <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400">Loading Class Data...</div>;
                          ...
                          <td key={col._id} className="p-3 border-r border-gray-50 dark:border-gray-700 print:border-black">
                            {isTeacher ? (
                                ...
                                <div className="print:hidden">
                                  {col.type === 'attendance' ? (
                                    <select
                                      ...
                                      className={`w-full p-2 rounded-lg text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:outline-none cursor-pointer border-transparent ${cellValue === 'Present' ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400' :
                              ...
                              <div className="flex justify-center">
                                {col.type === 'attendance' ? (
                                  <>
                                    <span className={`print:hidden px-3 py-1 rounded-full text-xs font-bold ${cellValue === 'Present' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' :
